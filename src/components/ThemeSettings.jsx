      ...
      bg-white dark:[#484B52] w-400">
        <div className="flex justify-between items-center p-4 ml-4">
          <p className="font-semibold text-xl">Settings</p>
            <button type="button"
              onClick={() => setThemeSettings(false)}/*this false */
        ...
        <div className="flex-col border-t-1 border-color p-4 ml-4">
            ...
            <div className="mt-4">
              ...
              checked ={currentMode === 'Light'}/>
                <label htmlFor="light" className="ml-2 text-md 
                cursor-pointer">
                  Light
            ...
            <div className="mt-4">
              ...
              checked ={currentMode === 'Dark'}/>
                <label htmlFor="dark" className="ml-2 text-md 
                cursor-pointer">
                  Dark
        ...
        <div className="flex-col border-t-1 border-color p-4 ml-4">
            ...
            <div className="flex gap-3">
              {themeColors.map((item, index) => (
                ...
                position = "TopCenter">
                  <div className="relative mt-2 curser-pointer flex
                  gap-5 items-center">
                    <button
                    type = "button"
