...
import {earninigData, SparklineAreaData, ecomPieChartData, earningData} from '../data/dummy';
      ...
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        ...
        items-center">
          <div>
            ...
            <p className="text-2xl">$63,438.56</p>
          </div>
        </div>
        <div className="mt-6">
          <Button
            ...
            <div className="mt-10 flex gap-10 flex-wrap justify-center">
              <div className="border-r-1 border-color m-4 pr-10">
                <div>
                  ...
                  <p className="text-fray-500 mt-1"> 
                    Budget
                  </p>
                </div>
                <div className="mt-8">
                  <p>
                    <span className="text-3xl font-semibold">$48,469</span>
                  </p>
                  <p className="text-fray-500 mt-1"> 
                    Expense
                  </p>
